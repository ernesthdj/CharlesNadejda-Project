...
-- Auteur  : Ernest
-- Version : 4.0 — consolidation post-migration v19
-- Date    : 2026-06-10
-- ============================================================
-- Etat final apres migrations v01..v19
-- 20 tables, 1 VIEW, 5 CHECK constraints
--
-- Ordre de creation (respecter les FK) :
--  1.  activites
--  2.  stocks
--  3.  activites_stocks        (FK -> activites, stocks)
--  4.  fournisseurs
--  5.  fiches_ingredients      (FK -> fournisseurs)
--  6.  lots_ingredients        (FK -> fiches_ingredients, fournisseurs, stocks)
--  7.  utilisateurs
--  8.  bom_contextes           (FK -> activites)
--  9.  bom_niveaux             (FK -> bom_contextes)
-- 10.  bom_fiches              (FK -> bom_niveaux)
-- 11.  bom_fiches_lignes       (FK -> bom_fiches, fiches_ingredients)
-- 12.  bom_productions         (FK -> bom_niveaux, bom_fiches)
-- 13.  bom_stocks              (FK -> bom_niveaux, bom_contextes, activites, bom_fiches, bom_productions)
-- 14.  bom_productions_lignes  (FK -> bom_productions, lots_ingredients, bom_stocks)
-- 15.  bom_reservations        (FK -> lots_ingredients, bom_contextes)
-- 16.  categories_web
-- 17.  clients
-- 18.  produits_web            (FK -> bom_fiches, categories_web)
-- 19.  commandes_web           (FK -> clients)
-- 20.  commandes_web_lignes    (FK -> commandes_web, produits_web)
