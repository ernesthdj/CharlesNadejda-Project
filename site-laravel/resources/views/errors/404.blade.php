@extends('layouts.app')
@section('title', 'Page non trouvee — ArtisaStock')

@section('content')
<div class="flex flex-col items-center justify-center py-20 text-center">

    {{-- Code d'erreur stylise --}}
    <p class="text-8xl font-display font-bold text-(--color-or) mb-4">404</p>
    ...
    <p class="text-(--color-text-light) max-w-md mb-8 leading-relaxed">
        ...
        Pas d'inquietude, nos patisseries sont toujours disponibles !
    </p>
